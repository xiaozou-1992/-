		...
		<div class="main" :style="{ height: layoutContentHeight }">
			...
			<a-form :form="form" :label-col="{ span: 5 }" :wrapper-col="{ span: 18 }" @submit="handleSubmit">
				...
				<a-form-item label="类型">
					<a-select :allowClear="true" v-decorator="['TypeID']" placeholder="全部" optionFilterProp="children" showSearch disabled>
...
import { getActivityDetail, GetActivityTypeList } from '@/api/follow';
