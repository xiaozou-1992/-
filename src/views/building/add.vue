			...
			<div class="main" id="new_message">
				<a-form-model ref="ruleForm" :model="form" :rules="rules">
					...
					<a-form-model-item label="年级" prop="Grade">
						<a-date-picker mode="year" placeholder="请选择年级" format="YYYY" :value="gradeYear" :open="yearPickShow" @panelChange="handlePanelChange" @openChange="handleOpenChange" @change="yearChange" />
...
import { AddStudent, UpdateStudent,DoGetDetailStudent } from '@/api/follow';
export default {
	props: {
		text: Object,
		ClassList: Array,
