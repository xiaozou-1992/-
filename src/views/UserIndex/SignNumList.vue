	...
	<div class="all" v-loading="loading">
		...
		<div>
			<el-table ref="singleTable" :data="data" border highlight-current-row style="width: 100%">
				...
				<el-table-column prop="AddTime" label="签到时间" min-width="120"></el-table-column>
			</el-table>
	...
	export default {
		...
		methods: {
			async getList() {
				...
				let res = await UserSignUserPageList(data);
				this.loading = false;
