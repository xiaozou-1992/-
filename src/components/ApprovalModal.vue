<template>
  <div class="aid">
    <div class="base">
      <p class="fixed-top">
		  <span v-if="approvalType!=6"> {{ approvalList.ConfirmState }}</span>
		  <span v-else>待初审</span>
...
export default {
	...
	data() {
		return {
			...
			content:'',
			menuTypeList:[
				{ ID:"1", Name:"待审核" }, { ID:"2", Name:"不通过" }, { ID:"3", Name:"待复审" }, { ID:"4", Name:"待复审审核" }, { ID:"5", Name:"通过" }, { ID:"6", Name:"待初审" }, { ID:"7", Name:"待初审复审" }
			]
